    ...
    >
      ...
      <div className="px-3">
        <motion.button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-violet-400/30 bg-gradient-to-r from-indigo-500/20 to-violet-500/20 py-2 text-[13px] font-medium text-violet-100 transition-shadow hover:shadow-[0_0_20px_rgba(139,92,246,0.35)]"
        >
